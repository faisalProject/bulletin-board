...
@section('contents')
    <div class="news-create">
        ...
        <form action="{{ route('news_admin_store') }}" method="POST" enctype="multipart/form-data" class="card">
          @csrf
          <div class="row-input">
            <div class="col">
              <div class="input-el">
              ...
              <div class="input-el">
                <label for="content" style="font-weight: 600">Naskah Berita</label>
              ...
              <div class="input-el">
                <label for="category_id" style="font-weight: 600">Pilih Kategori</label>
                <select name="category_id" id="category_id" class="form-select" aria-label="Default select example" style="width: 100%">
          ...
          <div class="row-input">
            <button type="submit" class="btn btn-add btn-responsive"><i class="bi bi-plus-circle-fill"></i>Tambah Berita</button>
          </div>
        </form>
    </div>
@endsection
